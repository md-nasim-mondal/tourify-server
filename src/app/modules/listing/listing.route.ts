...
// Update Listing Status (Admin/Guide)
router.patch(
  "/:id/status",
  auth(UserRole.ADMIN, UserRole.SUPER_ADMIN, UserRole.GUIDE),
  validateRequest(ListingValidation.updateListingStatusValidation),
